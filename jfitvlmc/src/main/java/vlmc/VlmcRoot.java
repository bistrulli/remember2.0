...
public class VlmcRoot extends VlmcNode {
    ...
    //			//initial state
    //			ArrayList<Integer> ctx=new
    // ArrayList<Integer>(Arrays.asList(Integer.valueOf(state.getLabel())));
    //			//System.out.println(state.toString(new String[] {""}));
    //			//va avanti finchè non vai in uno stato finale (il costo dello stato finale lo considero)
    ...
    public TreeMap<Integer, Double> simulate(
            int nrun, fitVlmc learner, ArrayList<ArrayList<String>> initCtxs) {
    ...
    private NextSymbolsDistribution createNextSymbolDistribution(
            ArrayList<String> ctx, fitVlmc learner) {
